...
let OwaspTop10Mapper = class OwaspTop10Mapper {
    version = '2021';
    map(headers, tls, dns) {
        return [
    ...
    mapA06VulnerableComponents(headers) {
            ...
            return [
                {
                    ...
                    recommendation: 'Remove or minimize information-disclosing headers to prevent attacker fingerprinting',
                },
            ];
        }
        return [
...
exports.OwaspTop10Mapper = OwaspTop10Mapper;
exports.OwaspTop10Mapper = OwaspTop10Mapper = __decorate([
    (0, common_1.Injectable)()
], OwaspTop10Mapper);
//# sourceMappingURL=owasp-top10.mapper.js.map