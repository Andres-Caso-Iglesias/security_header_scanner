...
**Language:** [English](../../README.md) | [Español](./docs/es/README.md)
...
- [docs/BACKEND.md](BACKEND.md): Arquitectura del backend, módulos, checkers, scoring, API, seguridad
- [docs/FRONTEND.md](FRONTEND.md): Frontend React + Vite + Tailwind, componentes, testing
- [docs/GUIA_USO.md](GUIA_USO.md): Guía de uso e interpretación de resultados
